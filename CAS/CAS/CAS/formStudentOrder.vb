...
Public Class formStudentOrder
    ...
    End Sub
    Private Sub formStudentOrder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ButtonBuy1_Click(sender As Object, e As EventArgs) Handles btnBuy1.Click
        ...
        Dim formStudentOrderPopUp = New formStudentOrderPopUp(productID, storeID, stdID, storeName)

        formStudentOrderPopUp.Show()
    End Sub
